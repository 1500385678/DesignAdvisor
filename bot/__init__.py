"""
DesignAdvisor · 飞书 bot 模块 (Phase 0 #4 闭环 + 飞书 bot 增强 1-5/5 + Phase 1 #2 评审通知 stub)
...
- notify_reviews:评审飞书通知 stub(Phase 1 #2 切第四刀 v0.1,3 事件 created/transitioned/decided)
...
__version__ = "0.5.0"  # 0917 +notify_reviews stub(Phase 1 #2 切第四刀 v0.1)
